...
class HouseSerializer(serializers.ModelSerializer):
    ...
    tasksLists=serializers.HyperlinkedRelatedField(read_only=True,many=True,view_name='task-detail',source='lists')


    class Meta:
        model=House
        fields=['url','id','image','name','created_on',
                'manager','description','members','members_count',
                'points','completed_tasks_count','not_completed_tasks_count','tasksLists']
