...
GS_BUCKET_NAME='##name of you bucket form gcloud'
GS_FILE_OVERWRITE=True
#GS_CREDENTIALS=service_account.Credentials.from_service_account_file("#path of copied key to vs code from created bucket")
